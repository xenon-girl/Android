...
import com.example.orderapp.Adapter.MyBestDealsAdapter;
import com.example.orderapp.Adapter.MyPopularCategoryAdapter;
...
//            Create Adapter
                MyPopularCategoryAdapter adapter = new MyPopularCategoryAdapter(HomeFragment.this.getContext(), popularCategoryModels);
